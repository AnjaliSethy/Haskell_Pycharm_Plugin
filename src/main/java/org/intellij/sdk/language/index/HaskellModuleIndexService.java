...
//
//public class HaskellModuleIndexService {
//
//    /**
...
//        Collection<HaskellFile> files = FileBasedIndex.getInstance().getValues(HaskellModuleIndex.HASKELL_MODULE_INDEX_ID, moduleName, scope);
//
